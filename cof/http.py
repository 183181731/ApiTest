...
class Http(object):
    ...
    * `METHOD`: 默认请求方法
    ...
    def post(self, url, params):
        ...
        #print "post method's response time is " + str( res["response_time"] ) +"ms"
        logger.info(url)
        logger.info(params)
        logger.info("===============================")
        logger.info(res["data"])
    ...
    def delete(self, url, params=None):
        ...
        res["response_header"] = response.msg.dict
        res["response_time"] = end_time - begin_time
        #print "delete method's response time is " + str( res["response_time"] ) +"ms"
    ...
    def patch(self, url, params):
        ...
        res["response_header"] = response.msg.dict
        res["response_time"] = end_time - begin_time
        #print "patch method's response time is " + str( res["response_time"] ) +"ms"
        conn.close()
        return res
    ...
    def put(self, url, params):
        ...
        res["response_header"] = response.msg.dict
        res["response_time"] = end_time - begin_time
        #print "put method's response time is " + str( res["response_time"] ) +"ms"
        conn.close()
        return res
...
#         res["response_header"] = c.getinfo(c.)      # 响应的头信息
        res["response_time"] = end_time - begin_time    # http响应的间隔时间，单位ms
        #print "get method's response time is " + str( res["response_time"] ) +"ms"
        logger.info(url)
        logger.info("===============================")
    ...
    def post(self, url, params, isjson = False):
        url = self.splice_url(url)
        storage = StringIO.StringIO()
        c = pycurl.Curl()
        if self.ssl:
